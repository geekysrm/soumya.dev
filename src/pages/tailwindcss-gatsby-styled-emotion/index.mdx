...
I was amazed by the stuff one can do using [Tailwindcss](https://tailwindcss.com). I watched in awe the [live streams](https://www.youtube.com/playlist?list=PL7CcGwsqRpSMgVc5NxXUpqmGOS9s1YrWF) of [Adam Wathan](https://twitter.com/adamwathan) (creator of tailwindcss) where he used to build various layouts using tailwindcss, without using any custom CSS.
